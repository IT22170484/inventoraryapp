...
const FormTable = ({ handleSubmit, handleOnChange, handleclose, rest, errors }) => {
    return (
        <div className="addContainer z-50">
            <form onSubmit={handleSubmit} className="relative">
                <div className="absolute top-3 right-3 rounded-full cursor-pointer hover:bg-black/10 duration-300" onClick={handleclose}>
                ...
                />
                {errors.Description && <span className="text-red-600 text-[12px] pl-[14px] pt-[4px]">{errors.Description}</span>}
                ...
                <input
                    ...
                    value={rest.Date}
                />
                {errors.Date && <span className="text-red-600 text-[12px] pl-[14px] pt-[4px]">{errors.Date}</span>}
                ...
                <input
                    ...
                    value={rest.Time}
                />
                {errors.Time && <span className="text-red-600 text-[12px] pl-[14px] pt-[4px]">{errors.Time}</span>}
    ...
    return (
        <div className="relative p-5 w-full h-full">
            ...
            <div className="flex justify-between w-full mb-10">
                ...
                <Box
                    component="form"
                    sx={{ borderRadius: "5px", display: 'flex', alignItems: 'center', width: 400, gap: "10px", border: "1px solid black" }}
                >
                    <InputBase
                        sx={{ ml: 1, flex: 1 }}
            ...
            <div className="w-full overflow-auto">
                {filterData().length > 0 ?
                    ...
                    </div> : <div className="text-center">No notices uploaded</div>
                }
            </div >
        </div >
    )
